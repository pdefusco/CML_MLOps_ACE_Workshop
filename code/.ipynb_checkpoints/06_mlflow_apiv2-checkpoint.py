...
experiment_id = "8ael-c9fu-wa6l-aj2t" # str | Experiment ID to search over.
...
CreateModelRequest = {
                        ...
                        "registered_model_id": "bnvt-jybf-n2oh-dve0"
                     }
...
try:
    ...
    api_response = client.get_registered_model(model_id=registered_model_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CMLServiceApi->get_registered_model: %s\n" % e)

model_version_id = "cdn2-bxby-b389-yus3"
    
model_id = "fc760eaa-0fb6-423e-a067-35315c83e0d0"
...
model_id = "fc760eaa-0fb6-423e-a067-35315c83e0d0" # str | ID of the model to get builds for.
